...
// Event Handlers
// ============================================
async function handleCheckoutCompleted(app, session) {
...
async function handleSubscriptionUpsert(app, subscription) {
...
async function handleInvoicePaid(app, invoice) {
