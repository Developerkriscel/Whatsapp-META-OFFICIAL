 ...
 */
export function getRateUsd(country, category) {
 ...
 */
export function getCostDescription(countryCode, category) {
 ...
 */
export function isFreeMessage(category) {
    return category === 'SESSION';
}
export async function calculateMessageCost(_prisma, _tenantId, country, category) {
...
// ============================================
export async function deductCredits(prisma, tenantId, amount, referenceId, referenceType, description) {
...
// ============================================
export async function maybeAutoRecharge(prisma, tenantId, balanceAfter) {
    ...
    if (!tenant?.autoRechargeEnabled)
        return;
    if (balanceAfter > tenant.autoRechargeThreshold)
        return;
...
// ============================================
export async function getTenantCreditInfo(prisma, tenantId) {
...
// ============================================
export async function recordMessageCredit(prisma, data) {
...
export function getAvailableCountries() {
    return Object.keys(META_RATES).filter(code => code !== 'OTHER' && !code.startsWith('ROW_'));
}
/**
