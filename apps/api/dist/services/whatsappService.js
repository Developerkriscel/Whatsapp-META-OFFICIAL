...
export async function dispatchOutboundMessage(params) {
    ...
    try {
        ...
        const metaPhoneId = phoneRecord?.metaPhoneId || creds?.metaPhoneId || (process.env.META_PHONE_NUMBER_ID !== 'your-phone-number-id' ? process.env.META_PHONE_NUMBER_ID : null);
